                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-12">
                                                        <div className="form-group">
                                                            ...
                                                            <input type="time" id="email-id-vertical" className="form-control" defaultValue={inputs.check_in_date} name="check_in_date" onChange={handleChange} placeholder="Check_In_Date" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="col-12">
                                                        <div className="form-group">
                                                            ...
                                                            <input type="time" id="email-id-vertical" className="form-control" defaultValue={inputs.check_out_date} name="check_out_date" onChange={handleChange} placeholder="Check_Out_Date" />
                                                        </div>
                                                    </div>
